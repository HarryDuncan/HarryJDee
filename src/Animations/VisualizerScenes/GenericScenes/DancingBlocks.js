            ...
            scene.traverse((o) => {
              if(o.isMesh && o.name === 'block'){
                if(count % 2 === 0){
                  ...
                  if(o.position.y > 2 && upperMaxFr > 0.7){
                   o.translateY(-upperMaxFr * 2)
                  }else if(o.position.y < 3 && lowerAvg > 90){
                     o.translateY(lowerMaxFr/2)
                  }else{
                    if(o.position.y < 2){
                      o.translateY(0.02)
                    }else{
                  ...
                  if(o.position.y < 3 &&  upperMaxFr >  0.7){
                    o.translateY(upperMaxFr)
                  }else if(o.position.y > 2 && lowerAvg > 90){
                     o.translateY(-lowerMaxFr/2)
                  }else{
                    if(o.position.y < 2 ){
                      o.translateY(0.02)
